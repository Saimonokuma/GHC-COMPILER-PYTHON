...
class TestPatchTargets:
    """Tests for _get_patch_targets binary filtering."""

    def test_get_patch_targets_ignores_binaries(self, tmp_path):
        from ghc_compiler_python.wrapper import _get_patch_targets
        ...
        targets = _get_patch_targets(tmp_path)
