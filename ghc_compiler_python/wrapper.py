...
class BaseResource:
    ...
    @classmethod
    def get_candidates(cls, base: pathlib.Path, version: str) -> List[pathlib.Path]:
        return []

    @classmethod
    def validate(cls, path: pathlib.Path) -> bool:
        return True

    @classmethod
    def extract_targets(cls, path: pathlib.Path) -> List[str]:
